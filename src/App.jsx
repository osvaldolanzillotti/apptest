...
function SMCRadioContent() {
  ...
  useEffect(() => {
    const configureApp = () => {
        ...
        if (!document.querySelector("script[src*='tailwindcss']")) {
            ...
            script.onload = () => setTimeout(() => setIsReady(true), 100);
  ...
  if (!isReady) {
      return <div className="fixed inset-0 bg-black flex items-center justify-center text-white font-sans">
        <div className="animate-pulse">Caricamento App...</div>
      </div>;
  }
